		...
		<div className="grid lg:grid-cols-10 grid-cols-1 lg:gap-6">
			...
			<div className="flex flex-col gap-4 col-span-6 ">
				...
				<div className="grid lg:grid-cols-2 grid-cols-1 gap-3">
					<button className="bg-[#F0BA43] text-[#FFFFFF] font-semibold md:h-[52px] h-[42px] px-4 py-2 rounded-lg hover:bg-yellow-500 transition-colors">
						Update your balance
					</button>
					<button className="border  border-gray-300 text-[#878787] font-semibold md:h-[52px] h-[42px] px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors">
