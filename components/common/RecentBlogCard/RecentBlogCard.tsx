    ...
    return (
        <article className="flex flex-col gap-4 w-full grow">
            ...
            <div className="flex flex-col grow">
                <h3 className="text-[15px] sm:text-[17px] font-semibold text-text-dark mb-2 leading-6">
                    {item.title}
                </h3>

                <p className="text-[13px] sm:text-[15px] text-text-gray mb-3 line-clamp-3 grow">
                    {item.text}
                </p>
                ...
                <div className="flex items-center gap-2 text-text-gray text-[13px]">
                    ...
                    <div>
                        <p className="text-[13px]">By {item.owner} / {item.date}</p>
                    </div>
                </div>
            </div>
        </article>
