...
const cardsData: InfoCard[] = [
    ...
    { id: "i2", title: "Give an Affirmation", subtitle: "Acknowledge great work" },
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {cards.map((card) => (
                        <div
                            key={card.id}
                            className="flex items-center gap-4 bg-gray-50 rounded-lg p-5 shadow-sm hover:shadow-md transition"
                        >
                            <div className="w-12 h-12 rounded-lg bg-white flex items-center justify-center text-gray-600">
                                {/* simple icon placeholder */}
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="3" y="7" width="14" height="10" rx="2" stroke="#CBD5E1" strokeWidth="1.5" />
                                    <path d="M21 7h-0" stroke="#CBD5E1" strokeWidth="1.5" />
                                </svg>
                            </div>

                            <div className="flex-1">
                                <div className="text-sm md:text-base font-medium text-gray-900">{card.title}</div>
