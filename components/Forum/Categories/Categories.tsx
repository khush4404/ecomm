                        ...
                        return (
                            <li key={t.key}>
                                <button
                                    ...
                                    className={`w-full text-left flex items-center gap-3 px-3 py-2 rounded-md transition-colors duration-150 ${isActive ? "bg-yellow-400 text-white font-medium" : "text-gray-700 hover:bg-gray-100"
                                        }`}
                                >
