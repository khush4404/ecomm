...
import { Check, BarChart3, Users, Mail, FileText, Bell } from "lucide-react";
			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					...
					<div className="flex flex-col rounded-[32px] overflow-hidden border border-gray-100 shadow-sm h-full">
						...
						<div className="bg-[#FFF6E5] p-6 h-[320px] relative flex flex-col">
							{/* Header: "Passion Farms" + Line */}
							<div className="flex items-center gap-4 mb-4">
								<p className="text-xs font-bold text-[#1D1D1D] whitespace-nowrap">
									Passion Farms
								</p>
								<div className="h-[1px] bg-[#F0BA43] w-full"></div>
							</div>

							{/* White Inner Card Container */}
							<div className="bg-white rounded-3xl shadow-md p-4 flex flex-col items-center justify-center flex-1 w-full mx-auto max-w-[280px]">
								...
								<div className="flex justify-center items-center relative w-full h-24">
									{/* Left Image */}
									<div className="w-16 h-20 relative rounded-xl overflow-hidden shadow-md transform -rotate-3 translate-x-2 border-2 border-white z-10">
										<Image
									...
									{/* Center Image */}
									<div className="w-20 h-24 relative rounded-xl overflow-hidden shadow-xl z-20 border-2 border-white -mt-2">
										<Image
									...
									{/* Left Connector Icon */}
									<div className="absolute left-[28%] top-1/2 -translate-y-1/2 w-6 h-6 bg-[#F0BA43] rounded-full flex items-center justify-center text-white border border-white z-30 shadow-sm">
										<Users size={12} />
									</div>

									{/* Right Connector Icon */}
									<div className="absolute right-[28%] top-1/2 -translate-y-1/2 w-6 h-6 bg-[#F0BA43] rounded-full flex items-center justify-center text-white border border-white z-30 shadow-sm">
										<Users size={12} />
									</div>
								</div>
							</div>
						...
						{/* Bottom Text Area */}
						<div className="bg-white p-8 flex-1 border-t border-gray-50 flex flex-col justify-start">
							<p className="text-[#1D1D1D] text-base leading-6 font-medium">
