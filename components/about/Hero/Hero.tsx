...
export const Hero = () => {
	return (
		// Outer container with the off-white/tan background color
				...
				<div className="grid grid-cols-1 md:grid-cols-2 md:gap-12 gap-8 items-center">
					...
					<div>
						...
						<p className="md:text-xl text-[12px] text-center md:text-start text-[#000000] md:mb-15 mb-6 max-w-lg">
							We Passion Farms is the fastest growing all-in-one
							ecosystem. Where verified suppliers, elite
							operators, and ambitious entrepreneurs scale through
							trust, compliance, and real business connections.
						</p>
