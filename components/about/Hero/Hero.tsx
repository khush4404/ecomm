	...
	return (
		<>
				...
				<div className="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 md:gap-12 gap-8 items-center">
						...
						<div>
							...
							<p className="md:text-xl text-[12px] text-center md:text-start text-black md:mb-15 mb-6 max-w-lg">
							...
							<div className="md:text-start text-center">
								<button className="md:px-10 md:py-4 px-8 py-3 md:text-2xl text-[12px]  rounded-4xl font-semibold text-white bg-[#F0BA43]">
									Book a Call
								</button>
							</div>
						</div>
						...
						<div className="flex flex-col space-y-6">
							...
							<div className="relative w-full h-auto">
								...
								<div className="absolute right-17 bottom-12 translate-x-1/4 translate-y-1/4 p-4 bg-white rounded-lg shadow-xl border border-gray-100 w-[180px] md:w-[220px]">
									<div className="text-[12px] font-semibold text-text-gray">
										Sales
									</div>
									...
									<Image
										...
										className="h-10 p-2"
									/>
									<div className="text-center text-xs text-text-grays mt-1 p-1 bg-black text-white w-fit left-20 bottom-15 absolute">
										1500
									</div>
								</div>
							</div>
							...
							<div className="flex   justify-between w-full md:space-x-6 space-x-1">
								...
								<div className="flex  w-full flex-col border border-[#F0BA43] justify-center items-center  p-4 bg-[#F0BA4333] rounded-xl">
									...
									<div className="text-black text-base md:text-[24px] text-center">
										Clients
									</div>
								</div>
								...
								<div className="relative w-full flex flex-col justify-center items-center  p-4 bg-[#F0BA43] rounded-xl">
									...
									<div className="text-[#FFFFFF] md:text-2xl text-base mt-2 text-center">
			...
			<div className="py-[100px]">
				<p className="text-center text-text-gray pb-10">
					Trusted by Thousands of Cannabis Operators Across the
					Country
				</p>
				<div className=" max-w-4xl flex justify-between mx-auto md:gap-15 gap-5 items-center">
					<Image
						src="/images/about/logo.png" // Change this to your actual image path
						alt="People working in a cannabis store"
						width={193}
						height={40}
						className=" h-[119px] w-[88px]"
					/>
					<Image
