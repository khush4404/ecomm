      ...
      <div className="flex flex-col lg:flex-row gap-6 px-4 md:px-9 py-8">
        ...
        <div className="flex-1">
          <div className="flex flex-col-reverse lg:flex-col">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8 pb-4 border-b border-[#BBBBBB]">
              <div className="flex items-center gap-3 text-sm w-full md:w-auto">
                <button
                  ...
                  className="flex lg:hidden items-center gap-2 font-medium bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-4 py-2 rounded-lg transition w-full md:w-auto justify-center"
                >
                  <svg
                    width="24"
                    height="24"
              ...
              <div className="flex flex-col md:flex-row flex-wrap items-center gap-4 text-sm w-full md:w-auto">
                ...
                <div className="flex items-center gap-2 w-full md:w-auto">
                  ...
                  <select
                    ...
                    className="px-3 py-2 text-gray-700 bg-white cursor-pointer  focus:outline-none"
                    style={{ letterSpacing: "-0.02em" }}
                  >
                ...
                <div className="hidden md:flex items-center gap-2 w-full md:w-auto">
                  ...
                  <select
                    ...
                    className="px-3 py-2 text-gray-700 cursor-pointer focus:outline-none"
                    style={{ letterSpacing: "-0.02em" }}
                  >
            ...
            <div className="h-[204px] md:h-[381px] w-full bg-gray-100 mb-8 rounded-[10px]">
            </div>
